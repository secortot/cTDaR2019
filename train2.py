# -*- coding: utf-8 -*-
# @Time    : 2020/1/15 19:42
# @Author  : secortot
# @Email   : secortot@163.com
# All Rights Reserved
import sys
import os
...
def train_net(net, args):
    ...
    for epoch in range(epochs):
        ...
        for i, data in enumerate(train_loader):
            ...
            loss=criterion(vmasks_pred,vmasks)
        ...
        if save_cp and epoch % 2 == 0:
            fpath=os.path.join(dir_checkpoint + 'CP{}.pth'.format(epoch + 1))
